...
namespace HAVIGAME.Editor {
    public static partial class EditorUtility {
        public static class Styles {
            ...
            private static GUIStyle toolbarbuttonRichText;
            public static GUIStyle ToolbarbuttonRichText {
                get {
                    if (toolbarbuttonRichText != null) {
                        return toolbarbuttonRichText;
                    }

                    toolbarbuttonRichText = Toolbarbutton;
                    toolbarbuttonRichText.richText = true;
